...
Esse trabalho teve como proposta desenvolver funções em JavaScript para passar nos testes unitários já previamente escritos.
Ao longo do bloco, nos dias anteriores a esse projeto, foram estudadas ferramentas das novas fucionalidades do ES6. Assim sendo, a proposta era que para uma maior simplicidade nos códigos, para que eles fossem escritos de forma expressiva e concisa, esperava-se a utilização das ferramentas do ES6 durante desenvolvimento.

O projeto foi bastante desafiador, pois envolvia o uso de um volume muito grande de ferramentas novas do ES6 que eu acabara de aprender. 
...
```bash
git clone https://github.com/AndreBarroso/sd-010-a-project-zoo-functions.git
```
